...
/* @var $model rbox\admin\models\Assignment */
...
$this->params['breadcrumbs'][] = ['label' => Yii::t('rbac-admin', 'User'), 'url' => ['/rbac/user/index']];
...
?>
<div class="assignment-index  container-fluid">
    <div class="row">
        <div class="col-sm-5">
