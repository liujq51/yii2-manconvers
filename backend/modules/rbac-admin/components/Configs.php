...
namespace rbac\admin\components;
 ...
 * 
 * ```
 * Yii::$container->set('rbac\admin\components\Configs',[
 *     'db' => 'customDb',
 *     'menuTable' => 'rbac_menu',
 * ]);
 * ```
...
class Configs extends \yii\base\Object
{
    ...
    public static function instance()
    {
        if (self::$_instance === null) {
            $type = ArrayHelper::getValue(Yii::$app->params, 'rbox.rbac.configs', []);
