...
'modules' => [
    ...
    'admin' => [
        'class' => 'rbox\admin\Module',
        'layout' => 'left-menu', // it can be '@path/to/your/layout'.
        'controllerMap' => [
            'assignment' => [
                'class' => 'rbox\admin\controllers\AssignmentController',
...
The code below shows how to use ACF which is implemented as `rbox\admin\components\AccessControl`:

```php
'as access' => [
    'class' => 'rbox\admin\components\AccessControl',
    'allowActions' => [
        'site/login', 
        'site/error',
    ]
